...
const gridProductProfile = (props) => (
...
const customerGridStatus = (props) => (
  <div className="flex gap-2 justify-center items-center text-gray-700 capitalize">
    <p style={{ background: props.StatusBg , propstextAlign:'Left'}} className="rounded-full h-3 w-3"  />
    <p>{props.Status}</p>
  </div>
);

export const customersGrid = [
  { type: 'checkbox', width: '50', textAlign:'Left' },
...
export const customersData = [
  {
    OrderID: 1001,
    CustomerName: 'Vinet Joshi',
    CustomerEmail: 'Vinet@gmail.com',
    CustomerImage:
      avatar3,
    ProductOrdered: 'Barkley Knight',
    Status: 'Delivered',
    StatusBg: '#8BE78B',
    Address: '40H Sector 30 ',
    Price: '$2.4k',
  ...
  },
  {
    ...
    PaymentStatus: 'Recieved',
    Price: '$3.9k',
    Address: 'A28 Sector 17 New Street',
  },
  {
    OrderID: 1003,
    ...
    Price: '$24.5k',
    Address: 'A28 Sector 15 MountView Hills',
  },
  {
    OrderID: 1004,
...
export const ProductsData = [
  ...
  },
  {
    ...
    Quantity: '10',
    Image:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3u4IyxSWSaOoItmAt9LCepOxhRMCowuQ2GRLRgZdNz2RUJwp0NbPHWcRC0ChrnzPV-TQ&usqp=CAU',
  },
  {
    ProductID: 1225,
    ...
    Quantity: '20',
    Image:
      'https://burst.shopifycdn.com/photos/hamburger-and-fries.jpg?width=1000&format=pjpg&exif=0&iptc=0',
  },
  {
    ProductID: 1342,
...
export const ordersData = [
  ...
  {
    OrderID: 345653,
    CustomerName: '170 Darrin',
    Quantity:'4',
    TotalAmount: 56.34,
    OrderItems: 'Wine Glass',
    Address: 'Delhi',
    Status: 'complete',
    StatusBg: '#8BE78B',
    ProductImage:
...
export const scheduleData = [
  {
    Id: 1,
    Subject: 'Order Recieved Payment Pending-Apple Watch',
    Address: 'A28 Red Cornor New Street Alaska',
  ...
  {
    Id: 2,
    Subject: 'Order Confirmed-Cheese Cake',
    Address: 'AW23/45 Newyork City',
  ...
  {
    Id: 3,
    Subject: 'Order Recieved -Bubble Shake',
    Address: 'A34/G New York Street',
  ...
  {
    Id: 4,
    Subject: 'Delivered-Cotton Candy',
    Address: 'D23 New Street Alaska',
  ...
  {
    Id: 5,
    Subject: 'Delivered-MobilePhone',
    Address: 'Sector 34 MountView Hills',
  ...
  {
    Id: 6,
    Subject: 'Shipped-Headphone Ptron',
    Address: 'B89 /123 New York Street',
  ...
  {
    Id: 7,
    Subject: 'Intransit-NeckBand Z Pro',
    Address: '56 78 Main Street, Anytown USA',
  ...
  {
    Id: 8,
    Subject: 'Out for Delivery-Nike Air',
    Address: 'Space Center A28 Sector 15 MountView Hills',
  ...
  {
    Id: 9,
    Subject: 'Order Recieved-Jordan Air',
    Address: 'Space Center A28 Sector 15 MountView Hills',
    StartTime: '2024-03-10T05:30:00.000Z',
    EndTime: '2021-03-10T07:30:00.000Z',
    CategoryColor: '#7fa900',
  },
  {
    Id: 10,
    Subject: ' Delivered-New Galaxy Fit3',
    Address: 'A34 Los Vegas',
  ...
  {
    Id: 11,
    Subject: 'Pending Yet Not Confirmed',
    Address: '56 Street Yv HomeTown',
  ...
  {
    Id: 12,
    Subject: 'Cancelled-Jordan Air',
    Address: 'D5 Street mountView',
  ...
  {
    Id: 13,
    Subject: 'Currently Working on Issue',
    Address: 'Space Center A28 Sector 15 MountView Hills',
  ...
  {
    Id: 15,
    Subject: 'Out for Delivery-Coffee ',
    Address: 'A4 Gem Street London ',
  ...
  {
    Id: 16,
    Subject: ' Shipped on the way-Burger',
    Address: '34A New City Alaska',
  ...
  {
    Id: 17,
    Subject: 'Deliver By Tomorrow-Noise Fit3 Watch',
    Address: 'A28 Sector 15 MountView Hills',
  ...
  {
    Id: 18,
    Subject: 'Out for Delivery-Choco Lava Cake',
    Address: 'Sector 15 MountView Hills',
  ...
  {
    Id: 19,
    Subject: 'Out for Delivery-Bubble Shake',
  ...
  {
    Id: 20,
    Subject: 'Shipped-Noise ColorFit3',
    Address: 'A28 Sector 17 MountView Hills',
  ...
  {
    Id: 21,
    Subject: 'Intransit Butter Scotch',
    Address: '78B Street Sector 5 MountView Hills',
  ...
  {
    Id: 22,
    Subject: 'Intransit  Chocolate Mousse',
    Address: ' A28 Sector 1 New Street',
  ...
  {
    Id: 23,
    Subject: 'Shipped-Vanilla Cream',
    Address: 'Street 5 Greenland',
  ...
  {
    Id: 24,
    Subject: 'Out for  Delivery - Blueberry Tart',
    Address: ' AW23 New Street California',
  ...
  },
  {
    ...
    Subject: 'Order Recieved Payment Pending-Apple Watch',
    Address: 'A28 Red Cornor New Street Alaska',
    StartTime: '2024-03-16T04:00:00.000Z',
    EndTime: '2021-03-16T06:30:00.000Z',
    CategoryColor: 'red',
  },
  {
    Id: 2,
    Subject: 'Order Confirmed-Cheese Cake',
    Address: 'AW23/45 Newyork City',
    StartTime: '2024-03-15T06:30:00.000Z',
  ...
  },
  {
    ...
    Subject: 'Order Recieved -Bubble Shake',
    Address: 'A34/G New York Street',
    StartTime: '2024-03-15T04:00:00.000Z',
    EndTime: '2021-03-15T05:30:00.000Z',
    CategoryColor: '#7fa900',
  },
];
...
export const pieChartData = [
  { x: 'Butter Scotch', y: 10, text: '8%' },
  
 
  
  { x: 'Wine', y: 11, text: '14%' },
  { x: 'Nike Air', y: 6, text: '6%' },
  { x: 'Jordan Air', y: 34, text: '34%' },
  { x: 'Noise Colorfit', y: 18, text: '20%' },
  
  { x: 'Barkley Knight', y:16 , text: '18%' },
];
...
export const stackedChartData = [
  [
    { x: 'Butter Scotch', y: '103' },
    { x: 'Jordan Air', y: '100' },
    { x: 'Nike Air', y: 147 },
    { x: 'Noise Colorfit', y: 109 },
    { x: 'Barkley Knight', y: 102 },
    { x: 'Burger', y: 104 },
    { x: 'Coffee', y: 102 },
 
  ],
  [
    { x: 'Butter Scotch', y: '100'  },
    { x: 'Jordan Air', y: '127' },
    { x: 'Nike Air', y: 147 },
    { x: 'Noise Colorfit', y: 109 },
    { x: 'Barkley Knight', y: 146 },
    { x: 'Burger', y: 154 },
    { x: 'Coffee', y: 155 },
